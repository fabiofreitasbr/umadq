                        ...
                        <div className="w-full relative z-50 md:w-1/2 h-full flex flex-col justify-center mb-4 ">
                            <div className=" container mx-auto max-w-lg">
                                ...
                                <div className="flex gap-x-4">
                                    <Link href="/programacao"><button className="border md:border-2 border-whiite hover:bg-white hover:text-red-500 font-normal text-sm md:text-base xl:text-lg py-2 px-3 lg:px-6 rounded-md text-white uppercase flex items-center transition-all mx-auto md:mx-0 hover:scale-105"><span className="inline"> ASSISTIR EVENTO </span></button></Link>
                                <Link href="/programacao"><button className="border md:border-2 border-whiite hover:bg-white hover:text-red-500 font-normal text-sm md:text-base xl:text-lg py-2 px-3 lg:px-6 rounded-md text-white uppercase flex items-center transition-all mx-auto md:mx-0 hover:scale-105"><span className="inline"> Nosso Eventos </span></button></Link>
                                </div>
                            </div>
                        </div>
