...
export default function Header() {
    ...
    return (
        <>
            ...
            <nav onClick={menuBurger} className={"block md:hidden z-40 w-full h-screen bg-red-900 fixed top-0 px-6 pt-20 transition-all duration-300 ease-in-out " + menuNavigation}>
                <div className="container mx-auto">
                    <ul className="flex flex-col text-2xl font-medium">
                        <li><Link href="/" className={"block w-full py-3 md:py-4 xl:py-5 text-white hover:text-yellow-500" + (namePath == '/' ? " !text-bege-500" : "")}>Home</Link></li>
                        <li><Link href="/agenda" className={"block w-full py-3 md:py-4 xl:py-5 text-white hover:text-yellow-500" + (namePath == '/agenda' ? " !text-bege-500" : "")}>Agenda</Link></li>
                        <li><Link href="/midia" className={"block w-full py-3 md:py-4 xl:py-5 text-white hover:text-yellow-500" + (namePath == '/midia' ? " !text-bege-500" : "")}>Fotos e Vídeos</Link></li>
                        <li><Link href="/espiritual" className={"block w-full py-3 md:py-4 xl:py-5 text-white hover:text-yellow-500" + (namePath == '/espiritual' ? " !text-bege-500" : "")}>Espiritual</Link></li>
                        <li><Link href="/programacao" className={"block w-full py-3 md:py-4 xl:py-5 text-white hover:text-yellow-500" + (namePath == '/programacao' ? " !text-bege-500" : "")}>Programação</Link></li>
                        <li><Link href="/equipe" className={"block w-full py-3 md:py-4 xl:py-5 text-white hover:text-yellow-500" + (namePath == '/equipe' ? " !text-bege-500" : "")}>Equipe</Link></li>
                    </ul>
                </div>
            </nav>
        </>
